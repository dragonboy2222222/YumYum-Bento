...
<head>
    ...
    <title>Terms and Conditions | Lunchbox Co.</title>
...
<main class="container py-5">
    <div class="card p-4 p-md-5">
        ...
        <section class="mb-5">
            ...
            <p>By accessing or using the services provided by Lunchbox Co., you agree to be bound by these Terms and Conditions. If you do not agree to these terms, please do not use our services.</p>
        </section>
        ...
        <section class="mb-5">
            ...
            <ul>
                ...
                <li><strong>4.3. Company Inability to Deliver:</strong> If Lunchbox Co. becomes unable to continue providing service to you (e.g., due to business closure, ceasing operations in your area), we will issue a full or prorated refund for any prepaid, undelivered meals. This is the only circumstance in which a refund will be provided.</li>
            </ul>
        </section>
        ...
        <section class="mb-5">
            ...
            <p>Lunchbox Co. will not be liable for any indirect, incidental, special, or consequential damages arising from your use of our services or any products purchased through the site. Our total liability to you will not exceed the amount you paid for your subscription in the last one month.</p>
        </section>

        <section class="mb-5">
            <h3>7. Intellectual Property</h3>
            <p>All content on this website, including text, graphics, logos, and images, is the property of Lunchbox Co. or its content suppliers and is protected by intellectual property laws. You may not use, reproduce, or distribute any content without our express written permission.</p>
        </section>
        
        <section class="mb-5">
            <h3>8. Governing Law</h3>
            <p>These Terms and Conditions are governed by the laws of the country in which Lunchbox Co. operates. Any disputes shall be resolved in the courts of that jurisdiction.</p>
        </section>
